  ...
  return (
    <>
      ...
      <ShiftChangeModal
        ...
        currentShiftPlan={userShiftPlan ? {
          shiftPlanName: userShiftPlan.shiftPlanName,
          shiftType: userShiftPlan.shiftType,
          startTime: userShiftPlan.startTime,
          endTime: userShiftPlan.endTime,
          workDays: userShiftPlan.workDays,
        } : null}
      />
